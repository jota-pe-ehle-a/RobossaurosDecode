...
@Autonomous(name = "AutoVermelhoMaior")
public class AutoVermelhoMaior extends LinearOpMode {
    ...
    Pose    startPose           =   new Pose(135, 126,Math.toRadians(45)),
            poseDeLancamento1   =   new Pose(101,93,Math.toRadians(45)),
            poseDeVisao         =   new Pose(82,74,Math.toRadians(90)),
            poseDeLancamento2   =   new Pose(84,9,Math.toRadians(65)),
    ...
    Path path23_1 = new Path(
            new BezierCurve(
                    poseDeVisao,new Pose(83,50),new Pose(84,29,Math.toRadians(0))
            )
    );
    Path path23_2 = new Path(
            new BezierLine(
                    new Pose(84,29,Math.toRadians(0)),new Pose(141,29,Math.toRadians(0))
            )
    );
    Path path23_3 = new Path(
            new BezierCurve(
                    new Pose(141,29,Math.toRadians(0)),new Pose(100,93),poseDeLancamento2
            )
    );
    Path path22_1 = new Path(
            new BezierCurve(
                    poseDeVisao,new Pose(69,44),new Pose(81,59,Math.toRadians(0))
            )
    );
    Path path22_2 = new Path(
            new BezierLine(
                    new Pose(81,59,Math.toRadians(0)),new Pose(130,59,Math.toRadians(0))
            )
    );
    ...
    Path path21_1 = new Path(
            new BezierCurve(
                    poseDeVisao,new Pose(58,27),new Pose(81,35,Math.toRadians(0))
            )
    );
    Path path21_2 = new Path(
            new BezierLine(
                    new Pose(81,35,Math.toRadians(0)),new Pose(138,35,Math.toRadians(0))
            )
    );
    Path path21_3 = new Path(
            new BezierCurve(
                    new Pose(138,35,Math.toRadians(0)),new Pose(96,96   ),poseDeLancamento1
            )
    );
    @Override
